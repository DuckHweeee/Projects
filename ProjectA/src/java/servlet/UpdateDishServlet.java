    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             DishManager myCDManager = new DishManager();
            int count = myCDManager.getByteData();
            ...
            if (mode.equals("view")) {
                ...
                Dish tempDish = myCDManager.getDishbyID(id);
                String mess= tempDish.getDescription();
            ...
            if (mode.equals("edit")) {
                ...
                String msg = "nothing";
                if (myCDManager.updateDish(newDish)) {
                    msg = "Update Success";
                    myCDManager.saveByteData();
                } else {
